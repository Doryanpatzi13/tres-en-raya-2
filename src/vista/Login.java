...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        init();// Llama al método de inicialización para configurar la ventana
    }
// Método para inicializar la ventana    
    public void init(){
        setUndecorated(true);  // Elimina la barra de título y bordes de la ventana
        initComponents(); // Inicializa todos los componentes gráficos de la interfaz
        setResizable(false); // Previene que el usuario pueda redimensionar la ventana
        setLocationRelativeTo(null); // Centra la ventana en la pantalla al abrirla
        
        
     // Método para inicializar y organizar los componentes de la interfaz gráfica    
    }
 ...
 // Método que se ejecuta al pasar el mouse sobre la etiqueta de cierre
    private void lblCierreMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCierreMouseEntered
        lblCierre.setForeground(Color.RED); // Cambia el color del texto a rojo
    }//GEN-LAST:event_lblCierreMouseEntered
// Método que se ejecuta al salir el mouse de la etiqueta de cierre
    private void lblCierreMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCierreMouseExited
        lblCierre.setForeground(new Color(240,192,255));// Restaura el color del texto
    }//GEN-LAST:event_lblCierreMouseExited
// Método que se ejecuta cuando el campo de usuario gana foco
    private void txtUsuarioFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUsuarioFocusGained
     // Se puede agregar lógica para cambiar el estilo del campo si se desea
    }//GEN-LAST:event_txtUsuarioFocusGained

    private void txtUsuarioFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUsuarioFocusLost
       // Se puede agregar lógica para restaurar el estilo del campo si se desea
    }//GEN-LAST:event_txtUsuarioFocusLost

    private void txtUsuarioMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtUsuarioMouseEntered
        // Se puede agregar lógica si se desea al pasar el mouse
    ...
    private void txtUsuarioMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtUsuarioMouseExited
         // Se puede agregar lógica si se desea al salir el mouse
    }//GEN-LAST:event_txtUsuarioMouseExited

    private void txtUsuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUsuarioKeyTyped
        // Se puede agregar lógica para limitar la entrada si se desea
    }//GEN-LAST:event_txtUsuarioKeyTyped
// Método que se ejecuta al presionar Enter en el campo de contraseña
    private void PasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasswordActionPerformed
        // Se puede agregar lógica si se desea al presionar Enter
